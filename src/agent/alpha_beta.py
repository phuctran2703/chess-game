...
class AlphaBetaAgent:
    ...
    def choose_move(self, board):
        ...
        for current_depth in range(1, self.max_depth + 1):
            ...
            for move in legal_moves:
                ...
                score = -self._alpha_beta(board, current_depth - 1, -beta, -alpha, -color_factor)
            ...
            print(f"Depth {current_depth} completed. Best move: {best_move} with score: {best_score}")
    ...
    def _alpha_beta(self, board, depth, alpha, beta, color_factor):
        ...
        if position_key in self.transposition_table and self.transposition_table[position_key]['depth'] >= depth:
